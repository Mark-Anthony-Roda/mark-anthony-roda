...
export default function HeroBanner() {
  ...
  return (
    <section
      id="introduction"
      className="relative flex flex-col justify-center items-center min-h-screen px-12 sm:px-18 md:px-24 lg:px-32 py-4"
    >
      <div className={`${classTheme[theme].textColor} w-full`}>
          ...
          <div className="flex flex-col gap-8 place-self-center text-center lg:text-left w-full">
            <h1 className="flex flex-col gap-8 text-3xl md:text-6xl font-black tracking-[4px]">
              ...
              <TypeAnimation
                ...
                wrapper="span"
                speed={50}
                className={classTheme[theme].textHightlight}
                repeat={Infinity}
